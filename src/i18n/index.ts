  ...
  en: {
    translation: {
      ...
      quranTracker: {
        ...
        notes: 'Notes',
        notesPlaceholder: 'Add any notes about your reading (e.g., verses that touched your heart)',
      ...
      settings: {
        ...
        ramadhanEndDate: 'Ramadhan End Date',
        ramadhanEndDateHelp: 'Set the last day of Ramadhan to calculate daily targets',
  ...
  id: {
    translation: {
      ...
      quranTracker: {
        ...
        notes: 'Catatan',
        notesPlaceholder: 'Tambahkan catatan tentang bacaan Anda (mis., ayat yang menyentuh hati)',
        target: 'Target Khatam',
        selectDate: 'Pilih Tanggal',
        invalidDate: 'Silakan pilih tanggal yang valid',
        futureDateError: 'Tidak dapat menambahkan progress untuk tanggal mendatang'
      },
      dailyIbadah: {
        title: 'Ibadah Harian',
      ...
      settings: {
        ...
        ramadhanEndDate: 'Tanggal Akhir Ramadhan',
        ramadhanEndDateHelp: 'Tentukan hari terakhir Ramadhan untuk menghitung target harian',
